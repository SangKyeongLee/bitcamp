...
public class Exam02_5 {
    public static void main(String[] args) throws Exception{
        ...
        // 인스턴스 메서드 활용
        System.out.println(c.get(1));// 년
        System.out.println(c.get(2)+1); // 월(0~11)
        System.out.println(c.get(5));// 일
        System.out.println(c.get(7));// 요일(1~7) 일 월 화 수 목 금 토
        ...
        System.out.println(c.get(Calendar.DAY_OF_WEEK));// 요일(1~7) 일 월 화 수 목 금 토
