...
public class Exam08_3 {
   ...
   @ResponseBody
    public String m1(String name, Model model) {
       ...
       return String.format("m1(): 모델객체를 통해서 세션에 값 넣기 - name=%s", name);
   }
   ...
   @ResponseBody
    public String m2(int age, Model model) {
       ...
       return String.format("m2(): 모델객체를 통해서 세션에 값 넣기 - age=%d", age);
   }
   ...
   @ResponseBody
    public String m3(boolean working, Model model) {
       ...
       return String.format("m3(): 모델객체를 통해서 세션에 값 넣기 - working=%b", working);
   }
