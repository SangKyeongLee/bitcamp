...
public class Exam07_2 {
   ...
   @ResponseBody
    public String m2(
       ...
       //@MatrixVariable을 사용하려면 
       //Matrix Variable 기능을 활성화 해야한다.
       //Spring WebMVC는 기본적으로 해당기능이 비활성화되어있다.
       //1. 자바코드로 활성화시키기
        //         @ComponentScan(..)
       //         @EnableWebMvc   <== 이 애노테이션을 붙여야한다.
   ...
   public String m3(
       ...
       // 예) 클라이언트에서 URL에 다음과 같은 형식으로 데이터를 보낼 때,
       //     ../exam07_2/m3/name=팀1;qty=6/name=작업100;state=1
   ...
   public String test() {
      ...
      buf.append("-------------------------\n");
      // 2) 프론트 컨트롤러의(DispatcherServlet)가 관리하는 Spring IoC 컨테이너 얻기 
